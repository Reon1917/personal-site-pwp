...
import SocialsContacts from './components/socials_contacts';
import './App.css';
  ...
  return (
    <div className="App">
      <header className="flex justify-end p-4">
        <button onClick={toggleTheme} className="swap swap-rotate transition-transform duration-500 ease-in-out">
          {theme === 'light' ? (
